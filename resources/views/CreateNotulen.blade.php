            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">Create Notulen</h4>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-2">
                                    ...
                                    <input type="time" class="form-control @error('jam_mulai') is-invalid @enderror" id="jam_mulai" name="jam_mulai" value="{{ date('Y-m-d') }}" required autofocus/>
                                    {{-- <input type="text" class="form-control @error('nama_pelanggan') is-invalid @enderror" id="nama_pelanggan" name="nama_pelanggan" required autofocus value="{{ old('nama_pelanggan') }}"/> --}}
                                    @error('jam_mulai')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="time" class="form-control @error('jam_selesai') is-invalid @enderror" id="jam_selesai" name="jam_selesai" value="{{ date('Y-m-d') }}" required autofocus/>
                                    {{-- <input type="text" class="form-control @error('nama_pelanggan') is-invalid @enderror" id="nama_pelanggan" name="nama_pelanggan" required autofocus value="{{ old('nama_pelanggan') }}"/> --}}
                                    @error('jam_selesai')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control @error('judul_meeting') is-invalid @enderror" id="judul_meeting"  name="judul_meeting" required autofocus value="{{ old('judul_meeting') }}"/>
                                    @error('judul_meeting')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
